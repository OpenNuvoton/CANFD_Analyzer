...
{   //data in mcu
    ...
    for(i = 0; i < vtp->gu32RxSize; i++)
        com_putchar(HSUSBD->EP[EPB].EPDAT_BYTE,IDX_VCOM0);
...
{   //data in mcu
    ...
    //pc_vcom -> usb -> mcu
    for(i = 0; i < vtp->gu32RxSize; i++)
        com_putchar(HSUSBD->EP[EPE].EPDAT_BYTE,IDX_VCOM1);
...
{   //data in mcu
    ...
    //pc_vcom -> usb -> mcu
    for(i = 0; i < vtp->gu32RxSize; i++)
        com_putchar(HSUSBD->EP[EPH].EPDAT_BYTE,IDX_VCOM2);
...
{   //data in mcu
    ...
    //pc_vcom -> usb -> mcu
    for(i = 0; i < vtp->gu32RxSize; i++)
        com_putchar(HSUSBD->EP[EPK].EPDAT_BYTE,IDX_VCOM3);

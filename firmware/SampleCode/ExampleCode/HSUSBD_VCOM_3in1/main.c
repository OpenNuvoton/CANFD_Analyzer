...
extern void UART_Module_Init(void);
...
//    printf("NuMicro USB CDC VCOM\n");
		...
		OLED_ShowString(0,0,"LIN--RS485--UART",0)	;	
		OLED_ShowString(0,2,"VCOM0 <-> U0 LIN",0)	;	
		OLED_ShowString(0,4,"VCOM1 <-> UART 2",0)	;			
		OLED_ShowString(0,6,"VCOM2 <-> U6 485",0)	;	

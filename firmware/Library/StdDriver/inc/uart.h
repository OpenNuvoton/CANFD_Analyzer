 ...
 * @file     uart.h
 * @version  V3.00
 * @brief    M460 series UART driver header file
 *
...
#define UART8_FIFO_SIZE 16ul /*!< UART8 supports separated receive/transmit 16/16 bytes entry FIFO \hideinitializer */
#define UART9_FIFO_SIZE 16ul /*!< UART9 supports separated receive/transmit 16/16 bytes entry FIFO \hideinitializer */
